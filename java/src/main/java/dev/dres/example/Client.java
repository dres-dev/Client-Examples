            ...
            try {
                logApi.postApiV2LogResultByEvaluationId(
                        ...
                        new QueryResultLog()
                                ...
                                .results(
                                        List.of(
                                                new RankedAnswer().rank(1).answer(new ApiClientAnswer().mediaItemName("some_item_name").start(1000L).end(1000L)),
                                                new RankedAnswer().rank(1).answer(new ApiClientAnswer().mediaItemName("some_item_name").start(5000L).end(5000L)),
                                                new RankedAnswer().rank(1).answer(new ApiClientAnswer().mediaItemName("some_other_item_name").start(12000L).end(12000L))
                                        )
                                )
